@code
    ...
    Dim floater1 As String = "../Content/XML/Svg/Site/Snowflake1.svg"
    Dim floater2 As String = "../Content/XML/Svg/Site/Snowflake2.svg"
    Dim floater3 As String = "../Content/XML/Svg/Site/Snowflake3.svg"
    Dim floater4 As String = "../Content/XML/Svg/Site/Snowflake5.svg"

    ' "sizeFactor" is used to increase or decrease overall size of floaters for each eventName
    Dim sizeFactor As Integer = 40
    Dim floaterCount As Integer = 8

    ' Assign Svg files to floaters based on "eventName"
    If eventName = "Christmas" Then
        floater1 = "../Content/XML/Svg/Site/Elf1.svg"
        floater2 = "../Content/XML/Svg/Site/Santa1.svg"
        floater3 = "../Content/XML/Svg/Site/Elf2.svg"
        floater4 = "../Content/XML/Svg/Site/Santa2.svg"
        sizeFactor = 100
        floaterCount = 6
    End If
    If eventName = "Autumn" Then
        floater1 = "../Content/XML/Svg/Site/Autumn1.svg"
        floater2 = "../Content/XML/Svg/Site/Autumn2.svg"
        floater3 = "../Content/XML/Svg/Site/Autumn3.svg"
        floater4 = "../Content/XML/Svg/Site/Autumn4.svg"
        sizeFactor = 40
        floaterCount = 12
    End If
    If eventName = "Halloween" Then
        floater1 = "../Content/XML/Svg/Site/Bat1.svg"
        floater2 = "../Content/XML/Svg/Site/Bat2.svg"
        floater3 = "../Content/XML/Svg/Site/Bat3.svg"
        floater4 = "../Content/XML/Svg/Site/Bat4.svg"
        sizeFactor = 120
        floaterCount = 12
    End If
    If eventName = "Valentines" Or eventName = "April" Then
        floater1 = "../Content/XML/Svg/Site/Heart1.svg"
        floater2 = "../Content/XML/Svg/Site/Heart2.svg"
        floater3 = "../Content/XML/Svg/Site/Heart3.svg"
        floater4 = "../Content/XML/Svg/Site/Heart2.svg"
        sizeFactor = 50
        floaterCount = 10
    End If
    If eventName = "Easter" Then
        floater1 = "../Content/XML/Svg/Site/Egg1.svg"
        floater2 = "../Content/XML/Svg/Site/Egg2.svg"
        floater3 = "../Content/XML/Svg/Site/Egg3.svg"
        floater4 = "../Content/XML/Svg/Site/Egg4.svg"
        sizeFactor = 75
        floaterCount = 8
    End If
    If eventName = "Thanksgiving" Then
        floater1 = "../Content/XML/Svg/Site/Pumpkin.svg"
        floater2 = "../Content/XML/Svg/Site/Turkey.svg"
        floater3 = "../Content/XML/Svg/Site/Pumpkin.svg"
        floater4 = "../Content/XML/Svg/Site/Turkey.svg"
        sizeFactor = 60
        floaterCount = 8
    End If
End Code
