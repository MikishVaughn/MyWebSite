...
<div style="padding-left: 15px; padding-right: 15px;">
    <h2>George Washington's Birthday</h2>
    <br />
    <p style="color: black;">
    ...
    <h6 style="font-size: 12px; text-align: right; padding: 0; margin: 0;"><button title="Reference" id="newTab" onclick="newTab('https://en.wikipedia.org/wiki/Washington%27s_Birthday')">More...(Wikipedia)</button></h6>
    <br />

    @*<p style="color: black;">
        <b>Like</b> the <b>Washington's Birthday</b> Countdown and share on Facebook with friends.
    </p>
    <div class="fb-like"
         style="height: 30px;
         padding-top: 5px;"
