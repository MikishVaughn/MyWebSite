...
<div style="padding-left: 15px; padding-right: 15px;">
    <img style="width: 80px; height: 80px;" src="~/Content/XML/Svg/Site/Turkey.Svg" /> <img style="width: 60px; height: 60px;" src="~/Content/XML/Svg/Site/Pumpkin.svg" />
    ...
    <h6 style="font-size: 12px; text-align: right; padding: 0; margin: 0;">
