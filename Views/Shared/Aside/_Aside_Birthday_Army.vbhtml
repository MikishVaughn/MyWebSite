...
<div style="padding-left: 15px; padding-right: 15px;">
    ...
    <h6 style="font-size: 12px; text-align: right; padding: 0; margin: 0;"><button title="Reference" id="newTab" onclick="newTab('https://en.wikipedia.org/wiki/U.S._Army_Birthdays')">More...(Wikipedia)</button></h6>
    <br />
