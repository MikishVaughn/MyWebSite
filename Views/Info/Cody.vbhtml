        ...
        <div Class="links-menu__module">
            ...
            <ul>
                <li class="links-menu__item">
                    <a href="~/Content/Misc/Cody/EscapesVol1.zip">Escapes Vol 1.zip (919,323 KB)</a>
                </li>

            </ul>
        </div>
        <div Class="links-menu__module">
            <h6 class="links-menu__header">Movies</h6>
            <ul>
                <li class="links-menu__item">
                    <a href="~/Content/Misc/Cody/Time.Bandits.zip">Time Bandits.zip (10.8 GB)</a>
                </li>
